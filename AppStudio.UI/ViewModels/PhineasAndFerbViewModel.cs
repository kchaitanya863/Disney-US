...
{
    public class PhineasAndFerbViewModel : ViewModelBase<YouTubeSchema>
    {
        override protected string CacheKey
        {
            get { return "PhineasAndFerbDataSource"; }
        }

        override protected IDataSource<YouTubeSchema> CreateDataSource()
        {
            return new PhineasAndFerbDataSource(); // YouTubeDataSource
        }
